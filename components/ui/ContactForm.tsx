...
export default function ContactForm() {
    ...
    return (
      <div className="bg-[var(--color-seedling-light)] rounded-2xl p-8 text-center">
        ...
        <button
          ...
          className="mt-4 font-label text-sm text-[var(--color-logo-forest)] uppercase tracking-[0.08em] underline"
        >
  ...
  const inputClass =
    'w-full px-4 py-3 rounded-xl border bg-[var(--color-warm-white)] font-body text-sm text-[var(--color-logo-deep-brown)] focus:outline-none focus:border-[var(--color-primary)] transition-colors'
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
      <div>
        <label htmlFor="name" className="block font-label text-xs uppercase tracking-[0.1em] text-[var(--color-logo-warm-brown)] mb-1.5">
          Your Name
        </label>
        <input
          id="name"
      ...
      <div>
        <label htmlFor="email" className="block font-label text-xs uppercase tracking-[0.1em] text-[var(--color-logo-warm-brown)] mb-1.5">
          Email Address
        </label>
        <input
          id="email"
      ...
      <div>
        <label htmlFor="subject" className="block font-label text-xs uppercase tracking-[0.1em] text-[var(--color-logo-warm-brown)] mb-1.5">
          Subject
        </label>
        <input
          id="subject"
      ...
      <div>
        <label htmlFor="message" className="block font-label text-xs uppercase tracking-[0.1em] text-[var(--color-logo-warm-brown)] mb-1.5">
          Message
        </label>
        <textarea
          id="message"
